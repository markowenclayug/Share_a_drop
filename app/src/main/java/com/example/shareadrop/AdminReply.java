...
public class AdminReply extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(AdminReply.this,MainActivity.class));
        ...
        navigationView.setCheckedItem(R.id.nav_admin_reply);
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.nav_home2:
                Intent intent = new Intent(AdminReply.this, Home2.class);
                startActivity(intent);
                break;
            case R.id.nav_profile2:
                intent = new Intent(AdminReply.this, Profile2.class);
                startActivity(intent);
                break;
            case R.id.nav_forum2:
                intent = new Intent(AdminReply.this, Forum2.class);
                startActivity(intent);
                break;
            case R.id.nav_map2:
                intent = new Intent(AdminReply.this, Map2.class);
                startActivity(intent);
                break;
            case R.id.nav_stocks2:
                intent = new Intent(AdminReply.this, Stocks2.class);
                startActivity(intent);
                break;
            case R.id.nav_report2:
                intent = new Intent(AdminReply.this, Report2.class);
                startActivity(intent);
                break;
            case R.id.nav_about_us2:
                intent = new Intent(AdminReply.this, AboutUs2.class);
                startActivity(intent);
                break;
